...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=LAPTOP-HB63NNNO\\ADMIN;Initial Catalog=SWP_MAIN_FP;User ID=sa;Password=123;Trust Server Certificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            entity.HasKey(e => e.UserId).HasName("PK__account__B9BE370FB87E4387");

            entity.ToTable("account");

            entity.HasIndex(e => e.UserEmail, "UQ__account__B0FBA212AAC5FB79").IsUnique();

            entity.HasIndex(e => e.Username, "UQ__account__F3DBC572AA68BD21").IsUnique();
        ...
        {
            entity.HasKey(e => e.AchievementId).HasName("PK__achievem__3C492E8393DBAC9F");
        ...
        {
            entity.HasKey(e => e.ChapterId).HasName("PK__chapter__745EFE87A63BDA7B");
        ...
        {
            entity.HasKey(e => e.ConversationId).HasName("PK__chatbot___311E7E9A08223741");
        ...
        {
            entity.HasKey(e => e.CourseId).HasName("PK__course__8F1EF7AE2FC65472");
            ...
            entity.HasMany(d => d.CourseCategories).WithMany(p => p.Courses)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("CourseId", "CourseCategoryId").HasName("PK__course_c__10F92220090CE15D");
        ...
        {
            entity.HasKey(e => e.CourseCategoryId).HasName("PK__course_c__FE7D58E8A48BF41F");
        ...
        {
            entity.HasKey(e => e.EnrollmentId).HasName("PK__enrollme__6D24AA7AC390510B");
        ...
        {
            entity.HasKey(e => e.FeedbackId).HasName("PK__feedback__7A6B2B8C22547C75");
        ...
        {
            entity.HasKey(e => e.LessonId).HasName("PK__lesson__6421F7BE4F828110");
        ...
        {
            entity.HasKey(e => e.LessonTypeId).HasName("PK__lesson_t__F5960D1E440C72FF");
        ...
        {
            entity.HasKey(e => e.NotificationId).HasName("PK__notifica__E059842F22E92563");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__payment__ED1FC9EAFEF816E5");
        ...
        {
            entity.HasKey(e => e.UserRole).HasName("PK__role__68057FEC8BEFD406");
        ...
        {
            entity.HasKey(e => e.StatusId).HasName("PK__status__3683B531F31878FE");
        ...
        {
            entity.HasKey(e => new { e.UserId, e.AchievementId }).HasName("PK__user_ach__9A7AA5E75834EBBF");
